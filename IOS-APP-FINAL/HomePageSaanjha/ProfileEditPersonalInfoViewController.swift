...
class ProfileEditPersonalInfoViewController: UIViewController, PHPickerViewControllerDelegate {
    ...
    // MARK: - User Data
    private var userName: String = UserDefaults.standard.string(forKey: "userName") ?? "Janhvi"
    private var userAge: Int = {
        let age = UserDefaults.standard.integer(forKey: "userAge")
        return age == 0 ? 32 : age
    }()
    private var userLocation: String = UserDefaults.standard.string(forKey: "userLocation") ?? "Mumbai,India"
